...
OPTIONS:
   ...
   -o <library folder name> The name of the output (library) folder for the results (e.g. 'SLX_20125')
...
if [[ -z "$OUTFOLDER" ]]; then usage; echo; echo "Error: output folder name must be supplied"; exit 1; fi
