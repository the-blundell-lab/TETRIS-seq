...
'''''
Watson code for retrieving the sample name and UDI from a csv file linking sample index and sample name.
...
Outputs:
    sample name and UDI (string)

Usage:
Watson_code_sample_name_from_UDI_index_with_UDI_v1.py  --samples_csv_file csv_file --fastq fastq_file_name
...
def main():
    ...
    sample_name_UDI = sample_name+'_'+UDI

    # print('sample name UDI = ', sample_name_UDI)

    return sample_name_UDI
