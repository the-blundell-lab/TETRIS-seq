...
'''''
Watson code for Duplex consensus calling.
...
Usage:
Watson_code_DCS_calling_1.4.py  --infile SSCS_BAM --sample-name sample_name --out-directory directory to save files in
