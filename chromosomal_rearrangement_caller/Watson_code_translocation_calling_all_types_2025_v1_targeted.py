...
def estimate_breakpoint_first_pass(NONHOM_output, HOM_output, INVLEFT_output, INVRIGHT_output, read_length, minimum_mapq, output_file, sample_name):
    ...
    one_breakpoint_found_NONHOM = shelve.open('./TEMP/'+sample_name+'_one_breakpoint_found_NONHOM_dict', flag = 'n')
    ...
    one_breakpoint_found_HOM = shelve.open('./TEMP/'+sample_name+'_one_breakpoint_found_HOM_dict', flag = 'n')
    ...
    one_breakpoint_found_INVLEFT = shelve.open('./TEMP/'+sample_name+'_one_breakpoint_found_INVLEFT_dict', flag = 'n')
    ...
    one_breakpoint_found_INVRIGHT = shelve.open('./TEMP/'+sample_name+'_one_breakpoint_found_INVRIGHT_dict', flag = 'n')
...
def main():
    ...
    NONHOM_output, HOM_output, INVLEFT_output, INVRIGHT_output = create_discordant_dictionary(bam_file, sample_name, discordant_NONHOM_qnames, discordant_HOM_qnames, discordant_INVLEFT_qnames, discordant_INVRIGHT_qnames, output_file, minimum_mapq)
